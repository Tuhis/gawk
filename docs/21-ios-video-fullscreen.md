...
(designed 2026-07-16, not started). Makes the viewer's fullscreen button
...
calling R16 done. If U1's probe fails on the real device, U2/U3 are
dropped per Decision 7 and U4 records the rejection.
