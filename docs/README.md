...
| [`52`](52-event-contract.md) | R51 (EC1 shipped) — Event contract: CloudEvents envelope, one JSON Schema per event type, AsyncAPI catalogue, Standard Webhooks delivery; the lifecycle rules for every event on the bus and in webhooks |
