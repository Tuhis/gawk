import { ServerIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    <ServerIcon style={{ fontSize: '16px' }} />
    <ServerIcon style={{ fontSize: '24px' }} />
    <ServerIcon style={{ fontSize: '32px' }} />
    <ServerIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><ServerIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><ServerIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><ServerIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><ServerIcon /></span>
  </div>
);
