...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <PinIcon style={{ fontSize: '32px' }} />
    <PinIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><PinIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><PinIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><PinIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><PinIcon /></span>
  </div>
);
