import { FocusIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    <FocusIcon style={{ fontSize: '16px' }} />
    <FocusIcon style={{ fontSize: '24px' }} />
    <FocusIcon style={{ fontSize: '32px' }} />
    <FocusIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><FocusIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><FocusIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><FocusIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><FocusIcon /></span>
  </div>
);
