...
export const Sizes = () => (
  <div style={canvas}>
    <MoreIcon style={{ fontSize: '16px' }} />
    <MoreIcon style={{ fontSize: '24px' }} />
    <MoreIcon style={{ fontSize: '32px' }} />
    <MoreIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><MoreIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><MoreIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><MoreIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><MoreIcon /></span>
  </div>
);
