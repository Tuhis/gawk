import { LeaveIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    <LeaveIcon style={{ fontSize: '16px' }} />
    <LeaveIcon style={{ fontSize: '24px' }} />
    <LeaveIcon style={{ fontSize: '32px' }} />
    <LeaveIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><LeaveIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><LeaveIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><LeaveIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><LeaveIcon /></span>
  </div>
);
