import { StatsIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <StatsIcon style={{ fontSize: '24px' }} />
    <StatsIcon style={{ fontSize: '32px' }} />
    <StatsIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><StatsIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><StatsIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><StatsIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><StatsIcon /></span>
  </div>
);
