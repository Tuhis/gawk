...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <StopIcon style={{ fontSize: '24px' }} />
    <StopIcon style={{ fontSize: '32px' }} />
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><StopIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><StopIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><StopIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><StopIcon /></span>
  </div>
);
