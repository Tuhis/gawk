...
export const Sizes = () => (
  <div style={canvas}>
    <GridIcon style={{ fontSize: '16px' }} />
    <GridIcon style={{ fontSize: '24px' }} />
    <GridIcon style={{ fontSize: '32px' }} />
    <GridIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><GridIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><GridIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><GridIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><GridIcon /></span>
  </div>
);
