import { CloseIcon } from 'gawk-app';
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><CloseIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><CloseIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><CloseIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><CloseIcon /></span>
  </div>
);
