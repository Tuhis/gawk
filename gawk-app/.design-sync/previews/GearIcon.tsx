...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><GearIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><GearIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><GearIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><GearIcon /></span>
  </div>
);
