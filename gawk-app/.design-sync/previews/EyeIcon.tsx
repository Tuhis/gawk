...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <EyeIcon style={{ fontSize: '32px' }} />
    <EyeIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><EyeIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><EyeIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><EyeIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><EyeIcon /></span>
  </div>
);
