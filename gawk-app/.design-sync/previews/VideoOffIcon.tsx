import { VideoOffIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    <VideoOffIcon style={{ fontSize: '16px' }} />
    <VideoOffIcon style={{ fontSize: '24px' }} />
    <VideoOffIcon style={{ fontSize: '32px' }} />
    <VideoOffIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><VideoOffIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><VideoOffIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><VideoOffIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><VideoOffIcon /></span>
  </div>
);
