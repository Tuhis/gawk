import { PeopleIcon } from 'gawk-app';
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><PeopleIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><PeopleIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><PeopleIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><PeopleIcon /></span>
  </div>
);
