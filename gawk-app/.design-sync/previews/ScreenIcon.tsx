import { ScreenIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    <ScreenIcon style={{ fontSize: '16px' }} />
    <ScreenIcon style={{ fontSize: '24px' }} />
    <ScreenIcon style={{ fontSize: '32px' }} />
    <ScreenIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><ScreenIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><ScreenIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><ScreenIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><ScreenIcon /></span>
  </div>
);
