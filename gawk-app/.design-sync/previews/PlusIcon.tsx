...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><PlusIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><PlusIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><PlusIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><PlusIcon /></span>
  </div>
);
