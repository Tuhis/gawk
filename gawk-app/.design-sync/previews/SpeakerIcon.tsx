import { SpeakerIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <SpeakerIcon style={{ fontSize: '32px' }} />
    <SpeakerIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><SpeakerIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><SpeakerIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><SpeakerIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><SpeakerIcon /></span>
  </div>
);
