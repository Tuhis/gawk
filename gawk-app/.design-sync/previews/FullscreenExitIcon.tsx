import { FullscreenExitIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <FullscreenExitIcon style={{ fontSize: '24px' }} />
    <FullscreenExitIcon style={{ fontSize: '32px' }} />
    <FullscreenExitIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><FullscreenExitIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><FullscreenExitIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><FullscreenExitIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><FullscreenExitIcon /></span>
  </div>
);
