import { FullscreenIcon } from 'gawk-app';
...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <FullscreenIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><FullscreenIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><FullscreenIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><FullscreenIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><FullscreenIcon /></span>
  </div>
);
