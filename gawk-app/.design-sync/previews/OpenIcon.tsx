...
export const Sizes = () => (
  <div style={canvas}>
    ...
    <OpenIcon style={{ fontSize: '32px' }} />
    <OpenIcon style={{ fontSize: '48px' }} />
  </div>
);
...
export const Tones = () => (
  <div style={{ ...canvas, fontSize: '32px' }}>
    <span style={{ color: 'var(--text)', display: 'inline-flex' }}><OpenIcon /></span>
    <span style={{ color: 'var(--muted)', display: 'inline-flex' }}><OpenIcon /></span>
    <span style={{ color: 'var(--accent)', display: 'inline-flex' }}><OpenIcon /></span>
    <span style={{ color: 'var(--danger)', display: 'inline-flex' }}><OpenIcon /></span>
  </div>
);
