...
| R15 | [System audio](#r15--system-audio) | 📋 designed 2026-07-15 (N1–N6); design refreshed 2026-07-19 post-R16–R20 (cluster cache invalidation, R19 carrier + resilient audio profile, defaults-flip mainlines audio-master pacing — docs/20 "Design refresh"); not started ([docs/20](docs/20-system-audio.md)) |
...
2026-07-19** against R16–R20 (docs/20 "Design refresh": second cache-
invalidation site for cluster mode, R19 carrier interplay + profile-carrying
audio buffer as new Decision 12, restart/reconnect sink-reset policy,
defaults-flip re-ordering of verification, R14 GStreamer wording fix); not
started.
