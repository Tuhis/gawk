...
| R34 | [Native Windows broadcaster](#r34--native-windows-broadcaster) | 🔧 designed 2026-07-30 (Rust + Media Foundation + Slint; owner decisions OD1–OD12); **WB0 scaffold + WB1 wire mirror implemented same day** (Cargo workspace, path-filtered `broadcast-windows` CI job, release-please component; golden vectors green incl. Go-generated GF(256) parity pins); WB2–WB8 not started ([docs/38](docs/38-windows-native-broadcaster.md)) |
