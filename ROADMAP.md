...
| R29 | [Forward parity for live-edge delivery](#r29--forward-parity-for-live-edge-delivery) | 🔧 designed 2026-07-27; **FP1–FP4 + FP5's recovery half implemented 2026-07-28**, automated gates green in all four modules; the default path works end to end. **FP5's viewer controls, FP6 (loss allowance), FP7 (telemetry) and FP8 (loss-injection + e2e) not started** — notably the feature has no test under real packet loss yet ([docs/34](docs/34-live-edge-forward-parity.md) §11) |
