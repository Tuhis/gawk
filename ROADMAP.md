...
the same stream) implemented 2026-09-23**, G1/G2/V-4 owner-pending — MB5–MB8
not started. Chunks in [docs/54](docs/54-macos-native-broadcaster.md).
