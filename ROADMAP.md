...
| R29 | [Forward parity for live-edge delivery](#r29--forward-parity-for-live-edge-delivery) | 🔧 designed 2026-07-27, not started (FP1–FP8); found by R28 telemetry on a real session ([docs/34](docs/34-live-edge-forward-parity.md)) |
